...
ALTER TYPE public.account_type OWNER TO cse340d;
...
CREATE TABLE IF NOT EXISTS public."orders" (
  ...
  CONSTRAINT fk_order_account FOREIGN KEY (account_id) REFERENCES public.account(account_id),
  CONSTRAINT fk_order_inventory FOREIGN KEY (inv_id) REFERENCES public.inventory(inv_id)
);
